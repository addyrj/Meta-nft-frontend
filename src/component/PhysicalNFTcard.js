...
function PhysicalNFTcard(props) {
    ...
    <>
      <Paper className={classes.root}>
        ...
        >
          ...
          {/* <Box
            style={{ position: "absolute", padding: "1px 11px" }}
            className="physicalstyle"
          >
            <Typography variant="body2" className="textphysical">
              Physical
            </Typography>
          </Box> */}
        </Box>
...
export default PhysicalNFTcard;
