...
export default function Sale({
  ...
  const getNftDetails = async (id, cancelTokenSource) => {
    setIsSubmit(false);
    try {
      const res = await axios.get(Apiconfig.viewPhysicalOrder + id, {
      ...
      if (res.data.statusCode === 200) {
        ...
        console.log("res.data.result++12", res.data.result);
        if (
          res.data.result?.collectionId?.contractAddress ||
          res.data.result?.nftId?.contractAddress
        ) {
        ...
        <>
          {!orderDetails ? (
            ...
            <>
                  ...
                  <Grid container spacing={1}>
                    ...
                    parseFloat(orderDetails?.endTime) <
                      ...
                      <>
                            ...
                            <Grid item lg={6} md={6} sm={12} xs={12}>
                              {Physicaldataprofile === "profile" ? (
                                ...
                                <>
                                  ...
                                  >
                                    Buy for1 ~ {orderDetails?.price} QIE{" "}
                                    {networkDetails &&
                        ...
                        {orderDetails?.nftId?.physicalType === "SINGLE" ? (
                          <></>
                        ) : (
                          <>
                            {account &&
                              // orderExtraDeails &&
                              // !isCancelled &&
                              orderDetails?.creatorId?.walletAddress?.toLowerCase() !==
                                account?.toLowerCase() && (
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <Button
                                    variant="contained"
                                    ...
                                    onClick={() => setOpenBuy(true)}
                                  >
                                    Buy for2 ~ {orderDetails?.price} QIE{" "}
                                    {networkDetails &&
                                      networkDetails?.nativeCurrency?.symbol}
                                  </Button>
                                </Grid>
                    ...
                    {console.log("orderExtraDeails++++", orderExtraDeails)}
                    {account &&
                      orderDetails &&
              ...
              {orderDetails?.nftId?.physicalType === "SINGLE" && (
                <>
                  {orderDetails && orderDetails.nftId.isPlace && (
                ...
                <Grid container spacing={0}>
                  <Grid item lg={8} md={8} sm={12} xs={12}>
                    ...
                    <Grid item lg={12} md={12} sm={12} xs={12}>
                      <Box className={classes.chain} mb={1}>
                        <Typography variant="h4">Fractional details</Typography>
                      </Box>
                      ...
                      <Box mb={2}>
                        <Grid container spacing={0}>
                          ...
                          <Grid lg={6} md={6} sm={6} xs={6}>
                            <Typography variant="body2">
                              {orderDetails?.nftId?.genQuantity}
                            </Typography>
                          </Grid>
                          ...
                          <Grid lg={6} md={6} sm={6} xs={6}>
                            <Typography variant="body2">
                              {orderDetails?.nftId?.soldQuantity}
                            </Typography>
                          </Grid>
                          <Grid lg={6} md={6} sm={6} xs={6}>
                            <Typography variant="subtitle2">
                    ...
                    <>
                      ...
                      orderExtraDeails?.seller?.toLowerCase() ===
                        account?.toLowerCase() && ( */}
                          <Grid item lg={12} md={12} sm={12} xs={12}>
                            {/* <QRCodeSVG
                              value={orderDetails?.nftId?.barQRcodeLink}
                            /> */}
                            <img
                              src={orderDetails?.nftId?.barQRcodeLink}
                              width="100%"
                          ...
                          <Box>
                            <FormControl fullWidth className={classes.margin}>
                              <TextField
                                ...
                                onChange={(e) => {
                                  if (
                                    e.target.value <= orderDetails?.quantity
                                  ) {
                            ...
                            <Box pt={2}>
                              ...
                              >
                                You will pay :{" "}
                                {numberofCopies * orderDetails?.price}
                              </Typography>
                              <Typography
                                variant="h6"
                                style={{ fontSize: "14px", fontWeight: "400" }}
                              >
                                Balance : {parseFloat(balanceValue).toFixed(4)}
                              </Typography>
                            </Box>
                          </Box>
                ...
                <>
                  {orderDetails?.nftId?.physicalType === "MULTIPLE" ? (
                    <Dialog
                      ...
                      maxWidth="xs"
                      open={isUpdateprice}
                      onClose={() => setIsUpdateprice(false)}
                      aria-labelledby="max-width-dialog-title"
                    >
                      <DialogActions>
                        <IconButton
                      ...
                      <DialogContent className={classes.dialogContent1}>
                        ...
                        <Box>
                          <FormControl fullWidth className={classes.margin}>
                            <TextField
                              ...
                              //   setNumberofCopies(e.target.value);
                              // }}
                              onChange={(e) => setNumberofPrice(e.target.value)}
                            />
                            {/* {isInvalidUrl && numberofCopies !== "" && (
                                <FormHelperText error>
                                  Please enter valid no of copies.
                        ...
                        <Box align="center" className="modal_button_div" mt={1}>
                          <Button
                            ...
                            onClick={() => {
                              if (!orderDetails?.nftId?.isResale) {
                                UpdateNewPriceBlockchainHandler();
                              } else {
                              }
                            }}
                            disabled={isUpdatingData}
                ...
                <>
                  {orderDetails?.nftId?.physicalType === "MULTIPLE" ? (
                    <Dialog
                      fullWidth="xs"
                      maxWidth="xs"
                      open={isUpdateQuantity}
                      onClose={() => setIsUpdateQuantity(false)}
                      aria-labelledby="max-width-dialog-title"
                    >
                      <DialogActions>
                        <IconButton
                      ...
                      <DialogContent className={classes.dialogContent1}>
                        ...
                        <Box>
                          <FormControl fullWidth className={classes.margin}>
                            <TextField
                              ...
                              // }}
                              onChange={(e) =>
                                setNumberofQuantity(e.target.value)
                              }
                            />
                            {/* {isInvalidUrl && numberofCopies !== "" && (
                                <FormHelperText error>
                        ...
                        <Box align="center" className="modal_button_div" mt={1}>
                          <Button
                            ...
                            onClick={() => {
                              if (!orderDetails?.nftId?.isResale) {
                                UpdateNewQuantityBlockchainHandler();
                              } else {
                              }
                            }}
                            disabled={isUpdatingData}
