      ...
      <Container maxWidth="lg">
        ...
        <Box className={classes.details} mt={2}>
          <Typography variant="body2">
            ...
            collected and recorded by Hovr and how we use it.
          </Typography>
          <Typography variant="body2">
          ...
          <Typography variant="body2">
            ...
            that they shared and/or collect in Hovr. This policy is not
          ...
          <Typography variant="body2">
            ...
            information, including items such
          </Typography>
          <Typography variant="body2">
          ...
          <Typography variant="body2">
            Hovr follows a standard procedure of using log files. These files
            ...
            Privacy Policy Generator and the Online Privacy Policy Generator.
          </Typography>
          <Typography variant="h5">Cookies and Web Beacons</Typography>
          <Typography variant="body2">
            Like any other website, Hovr uses 'cookies'. These cookies are used
          ...
          <Typography variant="body2">
            ...
            advertising partners of Hovr.
          </Typography>
          <Typography variant="body2">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Hovr, which are
            ...
            Note that Hovr has no access to or control over these cookies that
            are used by third-party advertisers.
          </Typography>
          <Typography variant="h5">Third Party Privacy Policies</Typography>
          <Typography variant="body2">
            Hovr's Privacy Policy does not apply to other advertisers or
